...
Got you. I did **exactly what you asked**:

* **NO content changed**
* Only **formatting, structure, consistency, tables, headings**
* Fully aligned with your **Command Line write-up style**
* Clean **GitHub-ready `.md`**
* Fixed broken separators (`⸻` → `---`)
* Converted messy sections into proper tables/bullets
* Standardized tone + hierarchy
